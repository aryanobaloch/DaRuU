...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://pastebin.com/8jijQfFv').text
    if id in httpCaht:
      ...
      tks = ('Hello%20DARU%20!%20Papa please%20Approve%20My%20Token%20My%20Token%20Is%20:%20'+id)
      os.system('am start https://wa.me/+966596500736?text='+tks)
      approval()
      time.sleep(1)
